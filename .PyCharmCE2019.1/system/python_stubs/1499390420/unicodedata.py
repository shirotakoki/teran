...
ucd_3_2_0 = None # (!) real value is '<unicodedata.UCD object at 0x000001F042A76788>'

ucnhash_CAPI = None # (!) real value is '<capsule object "unicodedata.ucnhash_CAPI" at 0x000001F042BABD20>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001F042B0B2B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='unicodedata', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001F042B0B2B0>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pycharm\\\\pythons4skeletons\\\\python37\\\\DLLs\\\\unicodedata.pyd')"
