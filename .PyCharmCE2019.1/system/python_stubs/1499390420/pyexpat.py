...
expat_CAPI = None # (!) real value is '<capsule object "pyexpat.expat_CAPI" at 0x000002C72BEFBD20>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C72BE5B2B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pyexpat', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C72BE5B2B0>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pycharm\\\\pythons4skeletons\\\\python37\\\\DLLs\\\\pyexpat.pyd')"
